...
stripe.api_key = "sk_test_51LdTSdAOhNXcMXOm4yHjugwwTxvs1R0RMq7F62zFPjo1tEen6TBe4EouIgtObHYUMT38EtSjgzNG34CBc7wCzM9t00lg7ixUTg"

def home(request):
    plans = FitnessPlan.objects
    return render(request, 'Payment_Handler/home.html', {'plans':plans})
        ...
        if request.user.is_authenticated:
            try:
                if request.user.customer.membership:
                    return render(request, 'Payment_Handler/plan.html', {'plan':plan})
...
def join(request):
    return render(request, 'Payment_Handler/join.html')
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'Payment_Handler/checkout.html',
...
def settings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            membership = False
    return render(request, 'Payment_Handler/settings.html', {'membership':membership,
